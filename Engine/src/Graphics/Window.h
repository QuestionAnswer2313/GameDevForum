...
force_inline void
window_enable_cursor(NativeWindow* window)
{
    glfwSetInputMode(window->GlfwWindow, GLFW_CURSOR, GLFW_CURSOR_NORMAL);
}
force_inline void
window_disable_cursor(NativeWindow* window)
{
    glfwSetInputMode(window->GlfwWindow, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
}
force_inline i32
window_is_cursor_disabled(NativeWindow* window)
{
    return glfwGetInputMode(window->GlfwWindow, GLFW_CURSOR) == GLFW_CURSOR_DISABLED;
}
